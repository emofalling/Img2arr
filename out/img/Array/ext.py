...
from PySide6.QtWidgets import QWidget, QLabel, QCheckBox, QSlider, QVBoxLayout, QHBoxLayout, QLineEdit
...
class UI(abcUI):
    ...
    def ui_init(self, widget: QWidget, ext: CDLL, save: dict | None):
        ...
        line1_layout.addLayout(num_base_layout, Qt.AlignmentFlag.AlignCenter)

        num_base_layout.addWidget(QLabel("进制(2~62): "))
        self.num_base_edit = QLineEdit()
        self.num_base_edit.setFixedWidth(25)
        ...
        line1_layout.addLayout(arr_prefix_layout, Qt.AlignmentFlag.AlignCenter)
        ...
        line1_layout.addLayout(arr_suffix_layout, Qt.AlignmentFlag.AlignCenter)
        ...
        line2_layout.addLayout(num_split_layout, Qt.AlignmentFlag.AlignCenter)
        ...
        line2_layout.addLayout(num_prefix_layout, Qt.AlignmentFlag.AlignCenter)
        ...
        line2_layout.addLayout(num_suffix_layout, Qt.AlignmentFlag.AlignCenter)
